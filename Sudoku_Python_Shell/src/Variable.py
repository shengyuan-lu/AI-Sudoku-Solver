...
class Variable:
    ...
    def __init__ ( self, possible_Values, row, col, block ):
        ...
        self.domain = Domain.Domain( possible_Values ) # domain object
    ...
    def getAssignment ( self ):
        if not self.isAssigned():
            ...
            return self.domain.values[0] # because if assigned, the domain will only have 1 value
