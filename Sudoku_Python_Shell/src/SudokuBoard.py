...
class SudokuBoard:
    ...
    # p = number of rows in each block (number of block columns)

    # q = number of columns in each block (number of block rows)

    # n = length of N * N grid (N = p * q)

    # m = the number of values filled in from the start

    # board = 2d array

    # filepath = path to an input file that can generate a 2d array
    ...
    # helper function for the generating the board with file
